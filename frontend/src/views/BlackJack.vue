  ...
  <div class="flex justify-center h-full">
    <div class="w-full md:w-8/12 flex-col">
      ...
      >
        <transition-group name="deal" tag="div" class="flex">
          <blackjackCard
            v-for="(val, i) in this.dealerCards"
            :isFaceDown="val"
            :key="i"
          />
        </transition-group>
    ...
    <div class="flex-col justify-center mt-44">
      ...
      <div class="flex justify-center mt-5">
        <div class="pa-2">
          <gameButton :text="'Hit'" :emit="'hit'" @hit="this.hit" />
        </div>
        <div class="pa-2">
          <gameButton :text="'Stand'" :emit="'stand'" @stand="this.stand" />
        </div>
      </div>
